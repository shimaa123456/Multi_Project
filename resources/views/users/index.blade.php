...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="scroll active"><a href="#home">{{ __('messages.home') }}</a></li>
                        <li class="scroll"><a href="#features">{{ __('messages.features') }}</a></li>
                        <li class="scroll"><a href="#services">{{ __('messages.services') }}</a></li>
                        <li class="scroll"><a href="#portfolio">{{ __('messages.portfolio') }}</a></li>
                        <li class="scroll"><a href="#about">{{ __('messages.about') }}</a></li>
                        <li class="scroll"><a href="#meet-team">{{ __('messages.team') }}</a></li>
                        <li class="scroll"><a href="#pricing">{{ __('messages.pricing') }}</a></li>
                        <li class="scroll"><a href="#blog">{{ __('messages.blog') }}</a></li>
                        <li class="scroll"><a href="#get-in-touch">{{ __('messages.contact') }}</a></li>
                        <li class="scroll">
                        <div class="form-group" style="padding-top: 35px; padding-left:20px;">
                            <label for="languageSelect">{{ __('messages.language') }}</label>
                            <select class="form-select" id="languageSelect" onchange="window.location.href=this.value">
                                <option value="{{ route('lang', 'ar')}}" {{ App::getLocale() == 'ar' ? 'selected' : '' }}>العربية</option>
                                <option value="{{ route('lang', 'en')}}" {{ App::getLocale() == 'en' ? 'selected' : '' }}>English</option>
                                <option value="{{ route('lang', 'fr')}}" {{ App::getLocale() == 'fr' ? 'selected' : '' }}>Française</option>
                            </select>
                        </div>
                        </li>
                        {{-- <li class="scroll">
                        ...
                        <li class="scroll">
                            <a href="{{ route('lang', 'fr')}}">Francaise</a>
                        </li> --}}
                    </ul>
    ...
    <section id="main-slider" style="direction: ltr important;">
        <div class="owl-carousel">
            ...
            @php
            $bannerTitle =  $oneMainBanner->{"title_{$locale}"};
            $bannerDescription =  $oneMainBanner->{"description_{$locale}"};
        @endphp
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    {{-- <h2>{{ $oneMainBanner->title_en }}</h2>
                                    <p>{{ $oneMainBanner->description_en }}</p> --}}
    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.ourWorks') }}</h2>
                <p class="text-center wow fadeInDown">{{ __('messages.worksDesc') }}</p>
            </div>
            ...
            <div class="portfolio-items">
                ...
                @foreach ($ourWork as $oneProject)
                    @php
                        $workTitle =  $oneProject->{"title_{$locale}"};
                        $workDescription =  $oneProject->{"description_{$locale}"};
                    @endphp
                    @php
                       //  $projectPhoto = "users/images/portfolio/" . $oneProject->photo;
                       // $projectPhoto = "ourWork/" . $oneProject->photo;
                    @endphp
                    <div class="portfolio-item {{$oneProject->categories}}">
                        <div class="portfolio-item-inner">
                            <img class="img-responsive" src="{{asset('ourWork/'.$oneProject->photo)}}" alt="">
                            <div class="portfolio-info">
                                <h3>{{$workTitle}}</h3>
                                {{$workDescription}}
                                <a class="preview" href="{{asset('ourWork/'.$oneProject->photo)}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-8 col-sm-6 col-sm-offset-6">
                        <div class="contact-form">
                            ...
                            <form {{-- id="main-contact-form" name="contact-form" --}} method="post" action="{{route('contactForm.store')}}">
                                @csrf
                                @method('POST')
